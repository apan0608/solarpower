 ...
 * @author Shenchen Pan
 * 
 * Entity class are already implemented for data store. Do we really need 
 * a customized entity??? 
 * This entity class is to store the data of a certain solarpower system.
 * Including size, cost, number of panels, panel efficiency loss, inverter
 *  efficiency, inverter replacement, inverter cost
 *
 */
