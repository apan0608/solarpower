...
public class HistoryResultsServlet extends HttpServlet implements Servlet {
    ...
    private void showhistory(HttpServletRequest req, HttpServletResponse resp) throws IOException,
            ServletException {
        /*
         * initial user service, and get user information. if user logged in, show data. Otherwise,
        ...
        /*
         * initial data store service and get history calculation data that's stored in datastore to
         * display on the calculate.jsp page
         */
